...
from .views import oee, main, RawDataViewSet, EquipmentWorksDetailView, repair_equipment, all_complexes, \
    complex_equipments, work_statistics, repair_view_data, repair_statistics, main_repairer, repair_statistics_diagram, \
    repair_history, stats_report
...
urlpatterns = [
                  ...
                  path('stats_report/', stats_report, name='stats_report'),
              ] + router.urls
